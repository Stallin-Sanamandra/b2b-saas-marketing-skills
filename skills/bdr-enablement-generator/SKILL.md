---
name: bdr-enablement-generator
description: >
  Generates account research briefs, personalized outreach sequences, persona-specific
  talk tracks, and objection handling frameworks for B2B SaaS BDR teams. Use when
  preparing BDR outreach for target accounts, building prospecting sequences, creating
  call scripts, developing objection responses, onboarding new BDRs, or reviewing
  outreach performance. Also use when asked to "write outreach emails," "build a
  prospecting sequence," "create a call script," "handle objections," or "research
  an account for outreach." Designed for BDR teams selling compliance, security, and
  GRC platforms to mid-market and enterprise buyers with multi-persona buying committees.
---
